...
//		include './includes/modules/payment/phpqrcode.php';
//		$qrCode = QRcode::png($_GET['qrcode'],false,0,5);

$smarty->assign('qrcode',        $_GET['qrcode']); // RSS URL

$smarty->display('pay.dwt', $cache_id);
