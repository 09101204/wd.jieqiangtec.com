...
//var_dump($_GET['sid'],$_SESSION['prom']['sid']);
if (
    (($_GET['item_id']) && ($_SESSION['prom']['item_id'] !== $_GET['item_id']))
    || (($_GET['sid']) && ($_SESSION['prom']['sid'] !== $_GET['sid']))
    || (($_GET['con_id']) && ($_SESSION['prom']['con_id'] !== $_GET['con_id']))
    || (($_GET['push_id']) && ($_SESSION['prom']['push_id'] !== $_GET['push_id']))
    || (($_GET['shop_id']) && ($_SESSION['prom']['shop_id'] !== $_GET['shop_id']))
    || (($_GET['bank_subid']) && ($_SESSION['prom']['bank_subid'] !== $_GET['bank_subid']))
    || (($_GET['bank_id']) && ($_SESSION['prom']['bank_id'] !== $_GET['bank_id']))
) {
    $_SESSION['prom'] = $_GET;
}

//var_dump($_SESSION['prom']);exit;
