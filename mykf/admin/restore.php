...
$msgs[]="数据恢复功能只能恢复由本系统导出的数据文件，其他软件导出格式可能无法识别";
...
<tr align="center" class="header"><th colspan="2" align="center">数据恢复</th></tr>
...
<tr><td colspan="2" align="center"> <input type="submit" name="act" value="恢复" style="line-height:30px;height:30px;font-weight:bold"></td>    </tr></table></form>
...
{
$msgs[]="本地备份文件上传成功";
if(import("../eqmkdata/sqlbaks/".$fname)) {$msgs[]="本地备份文件成功导入数据库"; unlink("../eqmkdata/sqlbaks/".$fname);}
