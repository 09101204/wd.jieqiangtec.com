...
function instheader() {
	...
	echo "<html><head>".
		...
		"<title>明科在线客服安装向导 $version </title>".
		...
		"<table width=\"95%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\" bgcolor=\"#FFFFFF\" align=\"center\"><tr><td>".
          	...
          	"<td class=\"install\" height=\"30\" valign=\"bottom\"><font color=\"#FF0000\">&gt;&gt;</font> 明科在线客服 $version&nbsp;$lang[install_wizard] ".
...
function instfooter() {
	...
	echo "<tr><td><hr noshade align=\"center\" width=\"100%\" size=\"1\"></td></tr>".
        	"<tr><td align=\"center\">".
            	"<b style=\"font-size: 11px\">Powered by <a href=\"http://eqmk.com\" target=\"_blank\">eqmk.com! $version".
          	"</a> &nbsp; Copyright &copy; <a href=\"http://www.eqmk.com\" target=\"_blank\">Eqmk Inc.</a> 2001-2007</b><br><br>".
...
function runquery($sql) {
	...
	$sql = str_replace("\r", "\n", str_replace(' eqmk_', ' '.$tablepre, $sql));
	$ret = array();
	$num = 0;
	foreach(explode(";\n", trim($sql)) as $query) {
		$queries = explode("\n", trim($query));
