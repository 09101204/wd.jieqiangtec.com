...
<div class="main">
    ...
    <div class="panel panel-info">
        <div class="panel-heading"><?php  echo $wkj['title'];?> 订单</div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8 col-lg-9">
                        <input class="form-control" name="keyword" id="" type="text"
                               value="<?php  echo $_GPC['keyword'];?>" placeholder="订单编号/收货手机号">
                    </div>
    ...
    <div style="padding: 0 15px 0  15px;">
        <div class="row-fluid">
            <div class="span8 control-group">
                <a class="btn btn-default" href="<?php  echo $this->createWebUrl('orderDownload',array('kid'=>$kid))?>"><i class="icon-download-alt"></i>导出订单信息</a>
                <a class="btn btn-default" href="<?php  echo $this->createWebUrl('OrderList',array('kid'=>$kid))?>">全部</a>
                <a class="btn btn-default" href="<?php  echo $this->createWebUrl('OrderList',array('kid'=>$kid,'status'=>$this::$KJ_STATUS_XD))?>">已下单</a>
                <a class="btn btn-default" href="<?php  echo $this->createWebUrl('OrderList',array('kid'=>$kid,'status'=>$this::$KJ_STATUS_GM))?>">已支付</a>
				 <a class="btn btn-default" href="<?php  echo $this->createWebUrl('OrderList',array('kid'=>$kid,'status'=>$this::$KJ_STATUS_YFH))?>">已发货</a>
            </div>
        </div>
            ...
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <td>
						...
						<?php  if(($row['status'] ==$this::$KJ_STATUS_XD && $wkj['pay_type'] ==2)) { ?>
						...
						<?php  } ?> 
							...
							<?php  if(($row['status'] ==$this::$KJ_STATUS_GM && $wkj['pay_type'] ==1)) { ?>
						 <a href="<?php  echo $this->createWebUrl('OrderList', array( 'id' => $row['id'],'kid'=>$wkj['id'], 'op' => 'fh'))?>"
                           onclick="return confirm('此操作不可恢复，确认发货？');return false;" title="发货"
                           class="btn btn-small">发货</a>
						<?php  } ?> 			
