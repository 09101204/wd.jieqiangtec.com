...
.category{display:block; overflow:hidden; background:#FCDAD5; border-top:1px #DDD solid;border-bottom:1px #DDD solid;}
...
.head{height:40px; line-height:40px; background:#E9342A; padding:0 5px; color:#FFF;}
...
.head .order{background:#f0645c; position:absolute; z-index:9999; right:0;}
...
.head .order li.fa-caret-up{font-size:20px;color:#f0645c;position:absolute;top:-11px;right:16px;}
