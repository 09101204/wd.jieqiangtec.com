...
(1, 1, '微信团队', 1, '', 'a:2:{s:8:"template";s:7:"default";s:12:"enablemodule";a:0:{}}', 1);
EOF;
$datas[] = "INSERT INTO `ims_site_styles` (`id`, `uniacid`, `templateid`, `name`) VALUES(1, 1, 1, '微站默认模板_gC5C');";
$datas[] = "INSERT INTO `ims_site_templates` (`id`, `name`, `title`, `description`, `author`, `url`, `type`) VALUES(1, 'default', '微站默认模板', '由微信提供默认微站模板套系', '微信团队', 'http://012wz.com', 1);";
...
EOF;
$datas[] = <<<EOF
INSERT INTO `ims_core_settings` (`key`, `value`) VALUES ('copyright', 'a:17:{s:8:"sitename";s:24:"微信微信管理系统";s:3:"url";s:17:"http://www.qq.com";s:8:"statcode";s:0:"";s:10:"footerleft";s:17:"powered by wiexin";s:11:"footerright";s:0:"";s:5:"flogo";s:0:"";s:5:"blogo";s:0:"";s:8:"baidumap";a:2:{s:3:"lng";s:10:"120.338133";s:3:"lat";s:9:"31.533899";}s:7:"company";s:39:"中国科技";s:7:"address";s:68:"中国";s:6:"person";s:9:"微信";s:5:"phone";s:11:"13888888888";s:2:"qq";s:9:"88888888";s:5:"email";s:0:"";s:8:"keywords";s:82:"微信,微信,微信公众平台,公众平台二次开发,公众平台开源软件";s:11:"description";s:82:"微信,微信,微信公众平台,公众平台二次开发,公众平台开源软件";s:12:"showhomepage";i:1;}');
EOF;
$datas[] = <<<EOF
INSERT INTO `ims_core_settings` (`key`, `value`) VALUES ('register', 'a:4:{s:4:"open";i:1;s:6:"verify";i:0;s:4:"code";i:1;s:7:"groupid";i:1;}');
EOF;
$datas[] = <<<EOF
INSERT INTO `ims_core_settings` (`key`, `value`) VALUES ('addons','a:2:{s:10:"addons_url";s:23:"http://addons.weizancms.com";s:5:"c_url";s:20:"http://www.qq.com";}');
EOF;
...
('1','basic','system','基本文字回复','1.0','和您进行简单对话','一问一答得简单对话. 当访客的对话语句中包含指定关键字, 或对话语句完全等于特定关键字, 或符合某些特定的格式时. 系统自动应答设定好的回复内容.','Weizan Team','http://www.qq.com/','0','','','1','1','0','0'),
('2','news','system','基本混合图文回复','1.0','为你提供生动的图文资讯','一问一答得简单对话, 但是回复内容包括图片文字等更生动的媒体内容. 当访客的对话语句中包含指定关键字, 或对话语句完全等于特定关键字, 或符合某些特定的格式时. 系统自动应答设定好的图文回复内容.','Weizan Team','http://www.qq.com/','0','','','1','1','0','0'),
('3','music','system','基本音乐回复','1.0','提供语音、音乐等音频类回复','在回复规则中可选择具有语音、音乐等音频类的回复内容，并根据用户所设置的特定关键字精准的返回给粉丝，实现一问一答得简单对话。','Weizan Team','http://www.qq.com/','0','','','1','1','0','0'),
('4','userapi','system','自定义接口回复','1.1','更方便的第三方接口设置','自定义接口又称第三方接口，可以让开发者更方便的接入微信系统，高效的与微信公众平台进行对接整合。','Weizan Team','http://www.qq.com/','0','','','1','1','0','0'),
('5','recharge','system','会员中心充值模块','1.0','提供会员充值功能','','Weizan Team','http://www.qq.com/','0','','','0','1','0','0'),
('6','chats','system','发送客服消息','1.0','公众号可以在粉丝最后发送消息的48小时内无限制发送消息','','Weizan Team','http://www.qq.com/','0','','','0','1','0','0'),
('7','voice','system','基本语音回复','1.0','提供语音回复','在回复规则中可选择具有语音的回复内容，并根据用户所设置的特定关键字精准的返回给粉丝语音。','Weizan Team','http://www.qq.com/','0','','','1','1','0','0'),
('9','images','system','基本图片回复','1.0','提供图片回复','在回复规则中可选择具有图片的回复内容，并根据用户所设置的特定关键字精准的返回给粉丝图片。','Weizan Team','http://www.qq.com/','0','','','1','1','0','0'),
('10','video','system','基本视频回复','1.0','提供视频回复','在回复规则中可选择具有视频的回复内容，并根据用户所设置的特定关键字精准的返回给粉丝视频。','Weizan Team','http://www.qq.com/','0','','','1','1','0','0');

";

$datas[] = <<<EOF
insert into `ims_modules`(`mid`,`name`,`type`,`title`,`version`,`ability`,`description`,`author`,`url`,`settings`,`subscribes`,`handles`,`isrulefields`,`issystem`,`issolution`,`target`) values
('8','custom','system','多客服转接','1.0.0','用来接入腾讯的多客服系统','','Weizan Team','http://www.qq.com','0','a:0:{}','a:6:{i:0;s:5:"image";i:1;s:5:"voice";i:2;s:5:"video";i:3;s:8:"location";i:4;s:4:"link";i:5;s:4:"text";}','1','1','0','0');
EOF;
...
(2, 1, 1, 8, 'site', '', '微信团队入口设置', '', '', './index.php?c=home&i=1&t=1');
EOF;
...
INSERT INTO `ims_account_wechats` (`acid`, `uniacid`, `token`, `encodingaeskey`, `access_token`, `jsapi_ticket`, `level`, `name`, `account`, `original`, `signature`, `country`, `province`, `city`, `username`, `password`, `lastupdate`, `key`, `secret`, `styleid`, `subscribeurl`, `card_ticket`, `topad`, `footad`, `auth_refresh_token`) VALUES
(2, 2, 'u35ambyoahgg4g13dntuhohw5nbpxb4l', '', '', '', 4, '默认测试(不用管可删除)', '', '', '', '', '', '', '', '', 0, 'wx570bc396a51b8ff8', '', 0, '', '', '', '', '');
INSERT INTO `ims_account` (`acid`, `uniacid`, `hash`, `type`, `isconnect`) VALUES
(2, 2, '', 3, 0);
INSERT INTO `ims_uni_account` (`uniacid`, `groupid`, `name`, `description`) VALUES
(2, 0, '全网发布测试数据，发布完成后可删除', '微信开放平台全网发布测试数据，完成后可删除');
...
ALTER TABLE  `ims_mc_members`  ADD  `credit6` decimal(10,2) unsigned NOT NULL;
