...
<footer id="footer-nav">
                <ul class="menu-list">
                    ...
                    <li <?php  if($footer_current=='commission') { ?>class='active'<?php  } ?>><a href="<?php  echo $this->createPluginMobileUrl('commission')?>"><i class="fa fa-sitemap"></i><span>分销中心</span></a></li>
