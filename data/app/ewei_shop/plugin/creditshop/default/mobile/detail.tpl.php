        ...
        function lottery(goods){
              var type = goods.type;
               if(type==0){
						...
						setTimeout(function(){
                                                 swal({ 'title':'',text:'恭喜您，优惠券兑换成功!', imageUrl:'../addons/ewei_shop/plugin/creditshop/template/mobile/default/images/lo1.gif', 
                                                  confirmButtonText: '确 定',
                                                  confirmButtonColor:'#f90' },function(){
                                                      location.href =core.getUrl('plugin/creditshop/log',{shine:1});
                                                  });   },1);						  
                                   ...
                                   setTimeout(function(){
                                       core.pjson('creditshop/detail' ,{'op':'lottery','id':"<?php  echo $id;?>",'logid':window.logid},function(json){
                                           if(json.status==-1){
                                              ...
                                              swal({ 'title':'',text:'恭喜中奖，优惠券已经发到您账户啦, !', imageUrl:'../addons/ewei_shop/plugin/creditshop/template/mobile/default/images/lo1.gif', 
                                                  confirmButtonText: '确 定',
                                                  confirmButtonColor:'#f90' },function(){
                                                      location.href =core.getUrl('plugin/creditshop/log',{shine:1});
                                                  });
